...
const Skills = () => {
  return (
    <div
      id="skills"
      className="bg-gradient-to-t from-black via-emerald-600 to-black h-screen sm:h-auto"
    >
      ...
      <div className="flex flex-col justify-center items-center mx-auto mt-44 sm:mt-20 sm:flex-row sm:justify-center sm:items-start sm:gap-10">
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="flex gap-10 p-10 sm:p-0 sm:flex-col">
